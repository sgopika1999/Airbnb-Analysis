...
with st.sidebar:
    ...
    options=["HOME","DATA EXPLORATION", "GEOSPATIAL ANALYSIS","TOP ANALYSIS"]
    default_option="HOME"
...
if selected=="HOME":
    ...
    with col1:
        st.image(Image.open("C:\\Users\\andro\\Downloads\\airbnb-logo.jpeg"), width=300)
        st.markdown("#### :red[**Technologies Used :**] Python Scripting, Data Preprocessing, Visualization, EDA, Streamlit, MongoDb, PowerBI.")
        
    with col2:
        st.markdown("#### :red[**Overview :**] Airbnb is an online marketplace that connects people who want to rent out their homes with those looking for accommodations.The platform allows hosts to list their available properties (ranging from single rooms to entire houses) and potential guests to find and book these accommodations for short-term stays.")
